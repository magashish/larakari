...
<div class="container-fluid nss_style add-service-date">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            ...
            >>
            <span class="insert_dates">Add Entry</span>
        </h1>
    </div>
            ...
            <div class="card shadow">
                <div class="card-body">
                    <form method="POST" action="{{ route('maintenance-log.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="description" class="col-md-4 col-form-label text-md-end">{{ __('Maintenance Description') }} <span class="text-danger">*</span></label>
                            <div class="col-md-6">
