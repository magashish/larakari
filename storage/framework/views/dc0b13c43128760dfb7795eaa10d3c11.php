  ...
  <div class="col-xl-12 col-md-12 mb-4 unit_title">
    <div class="row mb-3">
        <div class="col-md-12 col-form-label text-md-end">
            <label for="unit_type" class="col-form-label text-md-end"><?php echo e(__('Unit #:')); ?>  <span class="unit_id"><?php echo e(get_unit_detail($service->unit)->name); ?></span></label>           
        </div>       
    </div>
</div>
</div>
...
<div class="row">
  <div class="col-xl-12 col-md-12 mb-4 service-edit">
    ...
    <form class="input-form"  method="POST" action="<?php echo e(route('owner-services.update', $service->id)); ?>" enctype="multipart/form-data">
       <?php echo csrf_field(); ?>
    ...
    <!-- <div class="row mb-3">
        ...
        <div class="col-md-6">
         <select id="unit" class="form-control <?php $__errorArgs = ['unit'];
...
unset($__errorArgs, $__bag); ?>" name="unit" required>
           <?php $__currentLoopData = unit_type_owner_array(auth()->user()->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($value->id); ?>" <?php if( $service->unit == $value->id): ?> selected <?php endif; ?>><?php echo e($value->name); ?></option>
...
<div class="row mb-3">
    ...
    <div class="col-6">
        <!-- <span class="form-control"><?php echo e(date('h:i A', strtotime(get_unit_detail($service->unit)->checkin))); ?></span>                          -->
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <!-- <input id="arrival_time" type="time" class="form-control <?php $__errorArgs = ['arrival_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="arrival_time" value="<?php echo e(\Carbon\Carbon::parse($service->arrival_date)->format('H:i:s') !== '00:00:00' ? \Carbon\Carbon::parse($service->arrival_date)->format('H:i:s') : ''); ?>"> -->
...
<div class="row mb-3">
    ...
    <div class="col-6">
     <!-- <span class="form-control"><?php echo e(date('h:i A', strtotime(get_unit_detail($service->unit)->checkout))); ?></span>                          -->
...
<div class="row mb-3">
    ...
    <div class="col-md-6">
       <!-- <input id="departure_time" type="time" class="form-control <?php $__errorArgs = ['departure_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="departure_time" value="<?php echo e(\Carbon\Carbon::parse($service->departure_date)->format('H:i:s') !== '00:00:00' ? \Carbon\Carbon::parse($service->departure_date)->format('H:i:s') : ''); ?>"> -->
...
<div class="row mb-3">
    <div class="col-md-6 offset-md-4">
        <a href="<?php echo e(route('owner-services.index')); ?>" class="btn btn-primary"><?php echo e(__('Go Back')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1241039.cloudwaysapps.com/yuhjztazqa/public_html/resources/views/owner/edit_service.blade.php ENDPATH**/ ?>