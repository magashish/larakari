...
<div class="container-fluid nss_style">
  ...
  <div class="row">
      <div class="col-xl-12 col-md-12 mb-4 contactbclean">
          ...
          <form class="input-form user-add"  method="POST" action="<?php echo e(route('owner.post_contact_bclean')); ?>" enctype="multipart/form-data">
             <?php echo csrf_field(); ?>
             <div class="row mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1241039.cloudwaysapps.com/yuhjztazqa/public_html/resources/views/owner/contact_bclean.blade.php ENDPATH**/ ?>