...
<div class="container-fluid nss_style">
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><span class="rental">Rental Info </span> >> <span class="insert_dates"><a href="<?php echo e(route('owner-services.index')); ?>">View Dates</a></span></h1>
  </div>
        ...
        <div class="row mb-3">
            <div class="col-md-4 offset-md-4 col-form-label text-md-end">
                ...
                <select id="unit_type" class="form-control">
                    ...
                    <option value="<?php echo e(route('owner.owner_get_date', $value->id)); ?>" ><?php echo e($value->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <span class="all_dates"><a href="<?php echo e(route('owner.owner_get_date', 'all')); ?>">View All Dates</a></span>
            </div>
            <div class="col-md-6">              
            </div>
        </div>
  ...
  <div class="col-xl-12 col-md-12 mb-4 unit_title">
    <div class="row mb-3">
        <div class="col-md-12 col-form-label text-md-end">
            <label for="unit_type" class="col-form-label text-md-end unit_title_label"><?php echo e(__('Unit #:')); ?>  <span class="unit_id"><?php echo e(get_unit_detail($key)->name); ?></span></label> 
        </div>
      ...
      <div class="col-xl-12 col-md-12 mb-4">
        <div class="row mb-3">
            <div class="col-md-4 offset-md-4 col-form-label text-md-end">
                ...
                <select id="unit_type" class="form-control">
                    <option value="">Select Unit #</option>
                    <?php $__currentLoopData = unit_type_owner_array(auth()->user()->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keydata => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e(route('owner.owner_get_date', $value->id)); ?>" <?php echo e($key == $value->id ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-md-6">              
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1241039.cloudwaysapps.com/yuhjztazqa/public_html/resources/views/owner/unit_services.blade.php ENDPATH**/ ?>