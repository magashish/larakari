        ...
        <div class="row mb-3">
            <div class="col-md-4 col-form-label text-md-end  offset-md-4">
                ...
                <select id="unit_type" class="form-control">
                    ...
                    <option value="<?php echo e(route('admin.admin_create_date', $value->id)); ?>" ><?php echo e($value->name); ?></option>
...
<div class="row mobile_section d-md-none">
  <div class="col-xl-12 col-md-12 mb-4 mobile_service_section">
    <form id="service_form_mobile" class="input-form user-add"  method="POST" action="<?php echo e(route('services.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?> 
...
unset($__errorArgs, $__bag); ?>" name="service[1][unit]" value="<?php echo e($id); ?>" readonly>
            ...
            <div class="row mb-3" style="display:none;">
                <label for="owner_id" class="col-6 col-md-4 col-form-label text-md-end"><?php echo e(__('Owner')); ?></label>
                <div class="col-6">
                    <input  type="number" class="copy_value form-control <?php $__errorArgs = ['owner_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="service[1][owner_id]" value="<?php echo e($owner_id); ?>" readonly>
                </div>
            </div>
...
<div class="row desktop_section d-none d-md-block">
  <div class="col-xl-12 col-md-12 mb-4">
     <form id="service_form" class="input-form user-add"  method="POST" action="<?php echo e(route('services.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <tbody>               
            <tr class="clone_tr unit_item_1">
             ...
             <td style="display: none">  
                 <input type="number" class="form-control copy_value" name="service[1][owner_id]" value="<?php echo e($owner_id); ?>" readonly>                    
             </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1241039.cloudwaysapps.com/yuhjztazqa/public_html/resources/views/add_service.blade.php ENDPATH**/ ?>