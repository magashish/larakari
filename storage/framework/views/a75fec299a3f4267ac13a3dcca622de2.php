...
<div class="container-fluid">
    ...
    <div class="container-fluid nss_style">
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800"><span class="rental insert_dates"><a href="<?php echo e(route('home.manage')); ?>">Manage</a> </span> >> <span class="insert_dates"><a href="<?php echo e(route('services.index')); ?>">View Old Dates</a></span></h1>
  </div>
        ...
        <div class="row mb-3">
            <div class="col-md-4 offset-md-4 col-form-label text-md-end">
                ...
                <select id="unit_type" class="form-control">
                    <option value="<?php echo e(route('admin.get_old_services')); ?>">Select Unit #</option>
                    ...
                    <option value="<?php echo e(route('admin.get_old_services_by_unit', $value->id)); ?>" <?php echo e($id == $value->id ? 'selected' : ''); ?>><?php echo e($value->name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <span class="all_dates"><a href="<?php echo e(route('admin.get_old_services')); ?>">View All Old Dates</a></span>
            </div>
            <div class="col-md-6">              
            </div>
        </div>
        ...
        <div class="services_date_detail_more"> 
           <div class="services_date_detail_action" style="display: none;">       
            ...
            <div><strong>Created At </strong> <?php echo e(\Carbon\Carbon::parse($service->created_at)->format('l, d F Y \a\t h:i A')); ?></div>  &nbsp;         
             ...
             <div class="action">
               <span service-id="<?php echo e($service->id); ?>" class="btn btn-success btn-sm mb-1 service-show"><i class="fas fa-eye"></i></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/1241039.cloudwaysapps.com/yuhjztazqa/public_html/resources/views/old_services.blade.php ENDPATH**/ ?>